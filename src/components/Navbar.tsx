    ...
    >
      <div className="container flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          <a href="#features" className="text-sm font-medium text-white/80 hover:text-futuristic-blue transition-colors relative group">
            Features
          ...
          <a href="#use-cases" className="text-sm font-medium text-white/80 hover:text-futuristic-purple transition-colors relative group">
            Use Cases
          ...
          <a href="#waitlist" className="text-sm font-medium text-white/80 hover:text-futuristic-neon transition-colors relative group">
            Join Waitlist
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden fixed inset-0 top-16 z-40 dark:bg-black/95 bg-black/95 backdrop-blur-xl">
          ...
          <div className="flex flex-col items-center justify-center h-full space-y-8 p-4 relative z-10">
            <a 
              href="#features" 
              className="text-lg font-medium text-white hover:text-futuristic-blue transition-colors flex items-center"
            ...
            <a 
              href="#use-cases" 
              className="text-lg font-medium text-white hover:text-futuristic-purple transition-colors flex items-center"
              onClick={() => setIsMobileMenuOpen(false)}
            >
            ...
            <a 
              href="#waitlist" 
              className="text-lg font-medium text-white hover:text-futuristic-neon transition-colors flex items-center"
              onClick={() => setIsMobileMenuOpen(false)}
            >
