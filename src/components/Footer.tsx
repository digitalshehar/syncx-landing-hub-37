...
const Footer = () => {
  return (
    <footer className="relative backdrop-blur-xl bg-black/30 border-t border-white/10 py-12 md:py-16">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="col-span-1 md:col-span-1">
            <a href="/" className="text-2xl font-bold text-white mb-4 inline-block">
              Syncx<span className="text-white/70">.app</span>
            </a>
          ...
          <div>
            <h4 className="font-medium mb-4 text-white">Open-Source Partners</h4>
